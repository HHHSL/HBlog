...
document.writeln("            <a class=\'navbar-brand\' href=\'index\'>HHHSL</a>");
...
document.writeln("                        <a class=\'nav-link active\' aria-current=\'page\' href=\'index\'>Home</a>");
document.writeln("                    </li>");
document.writeln("                    <li class=\'nav-item\'>");
document.writeln("                        <a class=\'nav-link\' href=\'recommend\'>推荐</a>");
document.writeln("                    </li>");
document.writeln("                    <li class=\'nav-item\'>");
document.writeln("                        <a class=\'nav-link \' href=\'note\' tabindex=\'-1\' aria-disabled=\'true\'>笔记</a>");
document.writeln("                    </li>");
document.writeln("                    <li class=\'nav-item\'>");
document.writeln("                        <a class=\'nav-link \' href=\'daily\' tabindex=\'-1\' aria-disabled=\'true\'>日常</a>");
document.writeln("                    </li>");
document.writeln("                </ul>");
